...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
      ...
      if results_dic[key][3]==1 and if results_dic[key][2]==1:
    ...
    results_stats_dic['pct_correct_dogs'] = results_stats_dic['n_correct_dogs']/results_stats_dic['n_dog_img']*100.0
