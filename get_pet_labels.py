...
def get_pet_labels(image_dir):
    ...
    """
    # Creates list of files in the directory pet_images
    in_files= listdir(image_dir)
    results_dic= dict() # created empty dictionary to store the results.
